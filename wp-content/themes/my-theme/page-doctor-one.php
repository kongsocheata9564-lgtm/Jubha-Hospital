...
<section class="page-header-section">
    <div class="container">
        ...
        <h1 class="page-title">DR. LAN VEASNA</h1>
    </div>
</section>
...
<section class="doctor-simple">
    <div class="doctor-wrapper">
        ...
        <div class="doctor-photo">
            <img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/asset/m2.jpg' ); ?>" alt="Director" class="dept-img">
        </div>
        ...
        <div class="doctor-content">
            ...
            <p>
                Dr. Lan Veasna has over 15 years of experience in pediatric and general
