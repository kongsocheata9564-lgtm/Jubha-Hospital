...
<section class="page-header-section">
    <div class="container">
        ...
        <h1 class="page-title">DR. SAKHAN LEAKHENA</h1>
    </div>
</section>
...
<section class="doctor-simple">
    <div class="doctor-wrapper">
        ...
        <div class="doctor-photo">
            <img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/asset/m5.jpg' ); ?>" alt="Director" class="dept-img">
        </div>

        <!-- CONTENT -->
        <div class="doctor-content">
            <h2>Dr. Sakhan Leakhena</h2>
            <h4>General Practitioner & Pediatrician</h4>

            <p>
                Dr. Sakhan Leakhena has over 15 years of experience in pediatric and general
